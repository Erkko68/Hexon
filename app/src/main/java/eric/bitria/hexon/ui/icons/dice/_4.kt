...
val Icons._4: ImageVector
    get() {
        if (__4 != null) {
            return __4!!
        }
        __4 = Builder(name = "_4", defaultWidth = 800.0.dp, defaultHeight = 800.0.dp, viewportWidth
                = 20.0f, viewportHeight = 20.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = SolidColor(Color(0x00000000)),
                    strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
                moveTo(9.0f, 7.104f)
                curveTo(9.0f, 8.209f, 8.104f, 9.104f, 7.0f, 9.104f)
                curveTo(5.896f, 9.104f, 5.0f, 8.209f, 5.0f, 7.104f)
                curveTo(5.0f, 6.0f, 5.896f, 5.104f, 7.0f, 5.104f)
                curveTo(8.104f, 5.104f, 9.0f, 6.0f, 9.0f, 7.104f)
                lineTo(9.0f, 7.104f)
                close()
                moveTo(9.0f, 13.104f)
                ...
                lineTo(15.0f, 7.104f)
                close()
                moveTo(15.0f, 13.104f)
                curveTo(15.0f, 14.209f, 14.104f, 15.104f, 13.0f, 15.104f)
                curveTo(11.896f, 15.104f, 11.0f, 14.209f, 11.0f, 13.104f)
                curveTo(11.0f, 12.0f, 11.896f, 11.104f, 13.0f, 11.104f)
                curveTo(14.104f, 11.104f, 15.0f, 12.0f, 15.0f, 13.104f)
                lineTo(15.0f, 13.104f)
                close()
                moveTo(18.0f, 17.0f)
...
private fun Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = Icons._4, contentDescription = "")
    }
}
